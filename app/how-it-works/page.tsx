  ...
  return (
    ...
    <div className="container mx-auto py-12 px-4">
      ...
      <div className="max-w-3xl mx-auto">
        <h1 className="text-4xl font-bold mb-4">How ATTIRE Works</h1>
        ...
        <div className="space-y-8">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center gap-4">
              ...
              <div>
                <CardTitle>Step 2: AI Design Generation</CardTitle>
                <CardDescription>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center gap-4">
              ...
              <div>
                <CardTitle>Step 3: Cost Estimation</CardTitle>
                <CardDescription>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center gap-4">
              ...
              <div>
                <CardTitle>Step 4: Production & Delivery</CardTitle>
                <CardDescription>
