...
WSGI_APPLICATION = 'fashionai.wsgi.application'
...
REPLICATE_API_TOKEN = os.getenv('REPLICATE_API_TOKEN', 'r8_your-replicate-token-here')

# Celery settings (using Redis or fallback to database)
